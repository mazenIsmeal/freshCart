import { getBrandsById, getDataBrand } from '@/services/brand.service';
...
export default async function page({ params }: {params: Params}) {
    ...
    const brandById = await getBrandsById(id);
        ...
        <div className="bg-gradient-to-br from-green-600 via-green-500 to-green-400 text-white">
            <div className="container mx-auto px-4 py-12 sm:py-16">
                <nav className="flex items-center gap-2 text-sm text-white/70 mb-6">
                    ...
                    <span className="text-white/40">/</span>
                    <span className="text-white font-medium">{brandById.data.name}</span>
                </nav>
